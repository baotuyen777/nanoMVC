                    ...
                    <div id="masthead" class="header-main hide-for-sticky nav-dark">
                        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                            ...
                            <div id="logo" class="flex-col logo">
                                <!-- Header logo -->
                                <a href="<?php echo SITE_ROOT ?>" title="Choxanh247 - Bán buôn bán lẻ nữ trang" rel="home">
                                    ...
                                    <li class="cart-item has-icon
                                        ...
                                        <a href="<?php echo Helper::getPermalink('cart') ?>" title="Giỏ hàng" class="header-cart-link is-small">
                                            <span class="header-cart-title">
                                                Giỏ hàng     </span>
                                            <i class="icon-shopping-basket" data-icon-label="<?php echo isset($arrCart['data']) ? count($arrCart['data']) : 0 ?>">
                                            </i>
                                        </a>
                                        <ul class="nav-dropdown nav-dropdown-simple">
                                            <li class="html widget_shopping_cart">
                                                <div class="widget_shopping_cart_content">
                                                    <div class="cart_list">
                                                        <?php
                                                        // var_dump($arrCart); $hidden='hidden' ; 
                                                        if (isset($arrCart) && !empty($arrCart['data'])): $hidden = '';
                                                            ?>
                                                            <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                                <?php foreach ($arrCart['data'] as $product): ?>
                                                            ...
                                                            <p class="woocommerce-mini-cart__total total">
                                                                ...
                                                                <span class="woocommerce-Price-amount amount cart_total"><?php echo number_format($arrCart['total']) ?><span class="woocommerce-Price-currencySymbol">₫</span></span>
                                                            </p>
                                                    ...
                                                    <p class="btn_cart buttons <?php echo $hidden ?>">
                                                        ...
                                                        <a href="<?php echo Helper::getPermalink('cart/checkout') ?>" class="button checkout wc-forward">Đặt hàng</a>
                                                    </p>
                                                </div>
                                        ...
                                        <div id="cart-popup" class="mfp-hide widget_shopping_cart">
                                            <div class="cart-popup-inner inner-padding">
                                                ...
                                                <div class="widget_shopping_cart_content">
                                                    ...
                                                    if (isset($arrCart) && !empty($arrCart['data'])): $total = 0;
                                                        ?>
                                                        <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                            <?php
                                                            foreach ($arrCart as $product):
                                                                ...
                                                                <li class="woocommerce-mini-cart-item mini_cart_item">
                                                                    ...
                                                                    <a href="<?php echo Helper::getPermalink('product/' . $product->id) ?>">
                                                                        <img width="180" height="180" src="<?php echo TIMTHUMB_LINK . $product->image ?>" 
                                                                             class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" 
                                                                             sizes="(max-width: 180px) 100vw, 180px"><?php echo $product->name ?>&nbsp;			
                                                                    </a>
                                                                    <span class="quantity"><?php echo $product->quantity ?> × 
                                                        ...
                                                        <p class="woocommerce-mini-cart__total total">
                                                            <strong>Tạm tính:</strong>
                                                            <span class="woocommerce-Price-amount amount"><?php echo $total ?><span class="woocommerce-Price-currencySymbol">₫</span></span>
                                                        </p>
                                                        <p class="woocommerce-mini-cart__buttons buttons">
                                                            <a href="http://linhshop.com.vn/cart/" class="button wc-forward">Xem giỏ hàng</a>
                                                            <a href="http://linhshop.com.vn/checkout/" class="button checkout wc-forward">Đặt hàng</a>
                                                        </p>
                                                    <?php else: ?>
                                                        <p class="woocommerce-mini-cart__empty-message">Không có sản phẩm trong giỏ</p>
                                                    <?php endif; ?>
                            ...
                            <div class="flex-col hide-for-medium flex-left">
                                <ul class="nav header-nav header-bottom-nav nav-left  nav-divided nav-size-medium nav-spacing-xlarge nav-uppercase">
                                    ...
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="<?php echo Helper::getPermalink('page/aboutus') ?>" class="nav-top-link">Giới Thiệu</a></li>
