                                    ...
                                    <li class="cart-item has-icon
                                        ...
                                        <a href="<?php echo Helper::getPermalink('cart') ?>" title="Giỏ hàng" class="header-cart-link is-small">
                                            ...
                                            <i class="icon-shopping-basket"
                                               data-icon-label="<?php echo isset($arrCart['data']) ? count($arrCart['data']) : 0 ?>">
                                            </i>
                                        </a>
...
//                                                    var_dump($arrCart);
                                                        $hidden = 'hidden';
                                                        if (isset($arrCart) && !empty($arrCart['data'])):
                                                            $hidden = '';
                                                            ?>
                                                            ...
                                                            <p class="woocommerce-mini-cart__total total">
                                                                ...
                                                                <span class="woocommerce-Price-amount amount cart_total"><?php echo number_format($arrCart['total']) ?><span class="woocommerce-Price-currencySymbol">₫</span></span></p>
