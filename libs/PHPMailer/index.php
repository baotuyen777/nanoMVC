...
$mail->Username   = "baotuyen555@gmail.com"; // Tên đăng nhập tài khoản Gmail
$mail->Password   = "hoanganh3"; //Mật khẩu của gmail
$mail->SetFrom("baotuyen555@gmail.com", "Test Email"); // Thông tin người gửi
$mail->AddReplyTo("no-reply@example.com","Test Reply");// Ấn định email sẽ nhận khi người dùng reply lại.
$mail->AddAddress("baotuyen555@gmail.com", "John Doe");//Email của người nhận
